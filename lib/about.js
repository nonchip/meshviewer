define(function () {
  return function() {
    this.render = function (d) {
      ...
      s += "<p>Code <del>abused</del> <ins>improved</ins> for FFGI olsr mesh by <a href=\"http://nonchip.de\">Kyra 'nonchip' Zimmer</a>.<br/>"
      s += "You can get the modified version as a \"git diff\" output file <a href=\"git.diff\">here</a>.</p>"
